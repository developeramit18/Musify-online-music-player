...
export default function AdminDash() {
  ...
  return (
    <div className="w-full h-full">
      ...
      <h2 className="text-3xl text-center md:text-left font-semibold mb-6">Dashboard Overview</h2>


<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
  <div className="bg-white shadow-lg rounded-lg p-5 lg:p-6 flex flex-col items-center text-center">
    <h3 className="text-lg font-medium text-gray-500">Total Artists</h3>
    {loading ? (
  ...
  <div className="bg-white shadow-lg rounded-lg p-5 lg:p-6 flex flex-col items-center text-center">
    <h3 className="text-lg font-medium text-gray-500">Total Songs</h3>
    {loading ? (
  ...
  <div className="bg-white shadow-lg rounded-lg p-5 lg:p-6 flex flex-col items-center text-center">
    <h3 className="text-lg font-medium text-gray-500">Storage Usage</h3>
    {loading ? (
  ...
  <div className="bg-white shadow-lg rounded-lg p-5 lg:p-6 flex flex-col items-center text-center">
    <h3 className="text-lg font-medium text-gray-500">New Songs (Last 30 Days)</h3>
    {loading ? (
  ...
  <div className="bg-white shadow-lg rounded-lg p-5 lg:p-6 flex flex-col items-center text-center">
    <h3 className="text-lg font-medium text-gray-500">New Users (Last 30 Days)</h3>
    {loading ? (
      <p className="loading loading-spinner text-warning"></p>
    ) : (
      ...
      <div className="mt-10">
        ...
        <div className="bg-white shadow-lg rounded-lg p-3 md:p-5 lg:p-6 mb-6">
          <h3 className="text-xl text-center md:text-left font-semibold text-gray-700 mb-4">
  ...
  {dashData.recentlyAddedSongs.length > 0 ? (
    dashData.recentlyAddedSongs.map((song) => (
      <li
        key={song._id}
        className="flex justify-between items-center gap-2 text-gray-600 min-w-0"
      >
        <div className="flex-1 min-w-0">
          <span className="block truncate text-sm md:text-base">{song.title}</span>
        </div>
        ...
        <ul className="space-y-3">
          {dashData.recentlyAddedArtist.length > 0 ? (
            dashData.recentlyAddedArtist.map((artist) => (
              ...
              >
                <div className="flex-1 min-w-0">
          <span className="block truncate text-sm md:text-base">{artist.name}</span>
        </div>
        <span className="hidden md:inline-block text-gray-500">
