...
const SignupFooter = () => {
  ...
  return (
    <div className="w-full h-fit px-4 py-2 flex justify-between items-center bg-gradient-to-r from-purple-500 to-blue-500 text-white text-center md:text-left overflow-hidden">
